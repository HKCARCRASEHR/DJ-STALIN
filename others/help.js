...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("A firendly help from Joseph Stalin, your best friend!")
      .setAuthor('', 'https://i.kym-cdn.com/photos/images/original/000/220/724/1324499344002.gif', 'https://discord.com/api/oauth2/authorize?client_id=767885987740254291&permissions=49572160&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://i.kym-cdn.com/photos/images/original/000/220/724/1324499344002.gif")
      .setColor("#FF0000");

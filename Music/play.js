...
async execute(message, args, client) {
    ...
    if (!channel) return attentionembed(message, "Get into a VC!");
    //If not in the same channel return error
    if (serverQueue && channel !== message.guild.me.voice.channel)
      return attentionembed(message, `Get into my VC comrade! Not Hitler's!`);
    //If no args return
    if (!args.length)
    ...
    //get the thumbnail
    let thumb = "https://i.kym-cdn.com/photos/images/original/000/220/724/1324499344002.gif"

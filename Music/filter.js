...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#FF0000")
      .setAuthor("Applying: " + args[0], "https://i.kym-cdn.com/photos/images/original/000/220/724/1324499344002.gif","https://discord.com/api/oauth2/authorize?client_id=767885987740254291&permissions=49572160&scope=bot")).then(msg =>{
